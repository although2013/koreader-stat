...
// iconClass 传完整的 Tailwind 类名（而非拼接颜色），避免 CDN 版 Tailwind 漏掉动态类
function ChartCard({ title, icon, iconClass = 'bg-emerald-500/10 text-emerald-400', meta, className = '', children }) {
  return (
